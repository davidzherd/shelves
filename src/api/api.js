...
// Create new order
export const postNewOrder = async (depth, length, consealed, color, notes, price, phone, name)=>{
...
export const getData = async()=>{
    const request = await fetch('https://x8ki-letl-twmt.n7.xano.io/api:sQvFNZLW/orders');
    const rawData = await request.json();
    console.log(rawData)
